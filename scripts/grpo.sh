...
python -m curious.training.train_rl \
    ...
    --wandb_config.name "[grpo-padtoken-fixed]-grpo-qwen25-prompt[qwen]-reward[partial-solved-penalize-trailing]-temp1-5e06rl-epochperstep8-grad1-bsz16" \
