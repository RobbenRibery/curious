...
python -m curious.training.train_sfl \
    ...
    --wandb_config.name "sfl-drgrpo-qwen25-prompt[qwen]-reward[partial-solved-penalize-trailing]-temp1rep11-5e06rl-bsz16" \
