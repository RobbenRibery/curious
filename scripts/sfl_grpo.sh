...
python -m curious.training.train_sfl \
    --wandb_config.project "curious-gsm8k" \
    --wandb_config.group "sfl-grpo-test" \
    --wandb_config.name "sfl-grpo-qwen25-prompt[qwen]-reward[partial-solved-penalize-trailing]-temp1rep11-5e06rl-bsz16" \
    ...
    --sfl_config.sfl_enabled \
    --sfl_config.sfl_total_steps 30 \
    --sfl_config.sfl_sampling_batch_size 256 \
    --sfl_config.sfl_total_scanning_size 1024 \
    --sfl_config.sfl_num_samples_to_collect 256 \