...
DEFAULT_METRICS = (
    ...
    "train/rollout_questions",
    "train/rollout_samples",
    "train/minibatches_per_rollout",
    "train/update_advantage_abs_mean",
    "train/update_advantage_nonzero_fraction",
    "train/update_policy_ratio_mean",
    "train/update_policy_ratio_std",
    "train/update_policy_ratio_p50",
    "train/update_policy_ratio_p90",
    "train/update_clip_utilization_p90",
    "train/update_clip_utilization_p99",
    "train/update_ratio_above_clip_fraction",
    "train/update_clipped_token_count",
    "train/update_clipped_token_fraction",
    "train/update_clipped/saliency_mean",
    "train/update_clipped/multiplier_mean",
    "train/update_high_saliency_ratio_above_clip_fraction",
    "train/update_high_saliency/clip_utilization_p90",
    "train/update_clip_high_mean",
    "train/update_clip_high_min",
    "train/update_clip_high_max",
    "ad_cispo/clip_std",
    "ad_cispo/clip_p10",
    "ad_cispo/clip_p50",
    "ad_cispo/clip_p90",
    ...
    "ad_cispo/multiplier_p90",
    "ad_cispo/saliency_std",
    "ad_cispo/saliency_p90",
    "ad_cispo/high_saliency/clip_mean",
    "ad_cispo/high_saliency/multiplier_mean",
)
